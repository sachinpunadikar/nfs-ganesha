...
static struct config_item core_params[] = {
	...
	CONF_ITEM_BOOL("Enable_CLNT_AllV3Ops_Stats", false,
		       nfs_core_param, enable_CLNTALLV3STATS),
	CONF_ITEM_BOOL("Enable_CLNT_AllV4Ops_Stats", false,
		       nfs_core_param, enable_CLNTALLV4STATS),
